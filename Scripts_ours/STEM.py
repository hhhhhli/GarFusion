...
class STEM(nn.Module):
    def __init__(self, img_chs,num_classes, rgb_pretrained_model_path) -> None:
        ...
        self.resnet = models.resnet18(pretrained=True)# [BS, 512, 8, 8]
...
def main():
    ...
    for n in range(num_train):
        ...
        if 'STEM' in network_name:
            ...
            # rgb_pretrained_model_path = os.path.join('/home/hl/microscopy/codes/GarFusion_test/Model/reconstruct_codes/STEM/shape_model/', 'no_'+str(n+1).zfill(2))
            rgb_pretrained_model_path = None
